...
Route::get('/mailwatchExport', 'DemoController@watchExcel');
Route::get('/mailbandExport', 'DemoController@bandExcel');
Route::get('/mailJewelriesExport', 'DemoController@JewelriesExcel');
Route::get('/mailBezelExport', 'DemoController@BezelExcel');
Route::get('/mailBraceletExport', 'DemoController@BraceletExcel');
Route::get('/mailRingExport', 'DemoController@RingExcel');
Route::get('/mailNecklaceExport', 'DemoController@NecklaceExcel');
Route::get('/mailEarringExport', 'DemoController@EarringExcel');
Route::get('/mailDialExport', 'DemoController@DialExcel');
...
Route::get('/daily_report', 'DemoController@daily_report_mail')->name('product.daily_report');
...
Route::get('/lowstockemail', 'DemoController@lowstockemail')->name('lowstockemail');
...
Route::group(['middleware' => ['auth']], function() {
    ...
    Route::get('/all-memo','MemoController@exportCsv')->name('export.csv');
