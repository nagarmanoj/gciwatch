                                            ...
                                            <div class="aiz-checkbox-list" style="display:grid;height:100px; overflow: auto;">
                                                ...
                                                @foreach ($colors as $color)
                                                    ...
                                                    <label class="aiz-checkbox">
                                                        ...
                                                        <input  type="checkbox" name="color[]"  value="{{ $color->code }}" onchange="filter()"   @if(isset($selected_color) && $selected_color == $color->code) checked @endif>

                                                        <span class="aiz-square-check"></span>

                                                        <span>   {{ translate($color->name )}}</span>
                                            ...
                                            <div class="aiz-checkbox-list" style="display:grid;height:100px; overflow: auto;">
                                                ...
                                                @foreach ($partnersData_metal as $metal)
                                                    ...
                                                    <label class="aiz-checkbox">
                                                        ...
                                                        <input  type="checkbox" name="metal"  value="{{ $metal->option_value }}" onchange="filter()" >

                                                        <span class="aiz-square-check"></span>

                                                        <span>   {{ translate($metal->option_value )}}</span>
                                  ...
                                  <div class="bg-white shadow-sm rounded mb-3">
                                        ...
                                        <div class="aiz-checkbox-list" style="display:grid;height:50px; overflow: auto;">
                                                ...
                                                <label class="aiz-checkbox">
                                                    ...
                                                    <input  type="checkbox" name="paper_cart"  value="yes" onchange="filter()" >
                                                ...
                                                <label class="aiz-checkbox">
                                                    ...
                                                    <input  type="checkbox" name="paper_cart"  value="No" onchange="filter()" >
                                            ...
                                            <div class="aiz-checkbox-list" style="display:grid;height:100px; overflow: auto;">
                                                ...
                                                @foreach ($partnersData as $size)
                                                    ...
                                                    <label class="aiz-checkbox">
                                                        ...
                                                        <input  type="checkbox" name="size"  value="{{ $size->option_value }}" onchange="filter()">

                                                        <span class="aiz-square-check"></span>

                                                        <span>   {{ translate($size->option_value )}}</span>
