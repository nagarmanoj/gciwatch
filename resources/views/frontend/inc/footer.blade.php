                ...
                <div class="mt-4">
                    <a href="{{ route('home') }}" class="d-block">
                        @if(get_setting('footer_logo') != null)
                            <img class="lazyload" src="{{ static_asset('assets/img/placeholder-rect.jpg') }}" data-src="{{ uploaded_asset(get_setting('footer_logo')) }}" alt="{{ env('APP_NAME') }}" height="70">
                        @else
                ...
                <div class="text-center text-md-left mt-4">
                    ...
                    <ul class="list-unstyled">
                        <li class="mb-2">
                           ...
                           <span class="d-block opacity-70">{{translate('650 S Hill St. Suite 318, Los Angeles CA 90014') }}</span>
                        </li>
                        <li class="mb-2">
                           <!-- <span class="d-block opacity-30">{{translate('Phone :')}}</span> -->
                           <!-- <span class="d-block opacity-70">{{ get_setting('contact_phone') }}</span> -->
                           <span class="d-block opacity-70">{{translate('(213) 373-4424') }}</span>
                        </li>
                        <li class="mb-2">
                           ...
                           <span class="d-block opacity-70">
                               ...
                               <a href="mailto:{{ get_setting('contact_email') }}" class="text-reset">{{ translate('team@gcijewelry.com')  }}</a>
                            </span>
                        </li>
                    </ul>
                </div>
