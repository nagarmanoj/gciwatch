                                ...
                                <div class="aiz-carousel product-gallery-thumb" data-items='5' data-nav-for='.product-gallery' data-vertical='true' data-vertical-sm='false' data-focus-select='true' data-arrows='true'>
                                 ...
                                 @if($detailedProduct->video_link != "")
                                    ...
                                    <div class="carousel-box c-pointer border p-1 rounded">
                                        ...
                                        <a href="{{$detailedProduct->video_link}}" target="_blank">

                                            <img class="lazyload mw-100 size-50px mx-auto" src="https://gciwatch.com/assets/video2.png">
                        ...
                        <div class="text-left">
                            ...
                            @if ($detailedProduct->brand != null)
                                ...
                                <div class="col-auto d-flex pl-0">
                                    ...
                                    <a href="{{ route('products.brand',$detailedProduct->brand->slug) }}" style="text-decoration:none; color:#000;">

                                        <!-- <img src="{{ uploaded_asset($detailedProduct->brand->logo) }}" alt="{{ $detailedProduct->brand->getTranslation('name') }}" height="30"> -->

                                        <h6 class="mb-2 fs-15 fw-600">

                                            <!-- Brand:  -->

                                            <span>{{$detailedProduct->brand->name}}</span> </h6>
                            ...
                            <div class="col-auto pl-0">
                                ...
                                <h6 class="mb-2 fs-15 fw-600">
                                  ...
                                  Model Number :  <span>{{$detailedProduct->model;}}</span>
                            ...
                            <div class="col-auto pl-0">
                                 ...
                                 @if($detailedProduct->productcondition != null)

                                <h6 class="mb-2 fs-15 fw-600">

                                  Condition :  <span>{{ $detailedProduct->productcondition->name; }}</span>
                            ...
                            <h6 class="mb-2 fs-15 fw-600">
                              ...
                              Category :  <span>{{ $detailedProduct->category->name }}</span>
                            ...
                            <!-- @if ($detailedProduct->stock_id != null)

                            <p class="mb-2 fs-15 fw-600 ml-3">

                              Stock ID	 :  <span>{{ $detailedProduct->stock_id }}</span>
                                ...
                                <!-- @if ($detailedProduct->brand != null)
                                    ...
                                    <div class="col-auto">
                                        ...
                                        <a href="{{ route('products.brand',$detailedProduct->brand->slug) }}"> -->
                                            ...
                                            <!-- <h6>Brand: <span>{{$detailedProduct->brand->name}}</span> </h6>
                            ...
                            @if(home_price($detailedProduct) != home_discounted_price($detailedProduct))
                                ...
                                <div class="row no-gutters mt-3">
                                    ...
                                    <div class="col-sm-2">
                                        ...
                                        <div class=" my-2"><h6 class="mb-2 fs-15 fw-600">{{ translate('Price')}}: </h6></div>
                            ...
                            @else
                                ...
                                <div class="row no-gutters mt-3">
                                    ...
                                    <div class="col-sm-2">
                                        ...
                                        <h6 class="mb-2 fs-15 fw-600">{{ translate('Price')}}: </h6></div>
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <div class="product-quantity d-flex align-items-center">
                                            ...
                                            <div class="avialable-amount ">
                                                ...
                                                <h6> {{ translate('Quantity Available :')}}

                                                <span id="available-quantity">{{ $prostock }}</span> </h6>
                            ...
                            <div class="mt-3">
                                ...
                                @if ($detailedProduct->external_link != null)
                                     ...
                                     $data_contact = $detailedProduct->external_link;



                                     $data_contact = str_replace(" ","",$data_contact);
                                    ...
                                    <a type="button" class="btn btn-soft-primary mr-2 add-to-cart fw-600"  href="https://wa.me/{{$data_contact}}?text=Hi Gciwatch, I would like to place inquiry to this Product-{{$linkpage}}">

                                        <i class="lab la-whatsapp"></i>

                                        <span class="d-none d-md-inline-block"> {{ translate('Whatsapp Contact')}}</span>

                                    </a>

                                    <!-- <a type="button" style="font-size:15px;" class="btn btn-primary buy-now fw-600" href="">

                                        <i class="la la-shopping-cart"></i> {{ translate('Inquire')}}

                                    </a> -->

                                    @if (get_setting('conversation_system') == 1)

                                            <button class="btn btn-sm btn-soft-primary mr-2 add-to-cart fw-600" onclick="show_chat_modal()" style="font-size:15px;">{{ translate('Inquire')}}</button>
                                ...
                                @else
                                    ...
                                    <a type="button" class="btn btn-soft-primary mr-2 add-to-cart fw-600" href="https://wa.me/12133734424?text=Hi Gciwatch, I would like to place inquiry to this Product-{{$linkpage}}">
                                    ...
                                    <button class="btn btn-sm btn-soft-primary" onclick="show_chat_modal()" style="font-size:20px;">{{ translate('Inquire')}}</button>
                                ...
                                <a type="button" class="btn btn-link btn-sm btn-soft-primary btn-icon-left fw-600 compare_cart" onclick="addToCompare({{ $detailedProduct->id }})">
                                    ...
                                    <div class="row gutters-10 align-items-center">
                                        ...
                                        <div class="col-7 text-left">
                                            ...
                                            <h4 class="fs-13 text-truncate-2">
                                                ...
                                                <a href="{{ route('product', $top_product->slug) }}" style="font-size:10px;" class="d-block text-reset">{{$top_product->brand_name}} | {{$top_product->category_name}}</a>

                                            </h4>

                                            <h4 class="fs-13 text-truncate-2">

                                                <a href="{{ route('product', $top_product->slug) }}" class="d-block text-reset">{{ $top_product->model}}</a>
                ...
                <div class="col-xl-9 order-0 order-xl-1">
                    ...
                    <div class="bg-white mb-3 shadow-sm rounded">
                        ...
                        <div class="nav border-bottom aiz-nav-tabs">
                            ...
                            <a href="#tab_default_5" data-toggle="tab" class="p-3 fs-16 fw-600 text-reset active show">{{ translate('Product Details')}}</a>
                                    ...
                                    <div class="mw-100 overflow-hidden text-left aiz-editor-data">
                                        ...
                                        <table class="table">
                                          ...
                                          <tbody>
                                            ...
                                            @if($detailedProduct->productType != null)

                                            <!-- <tr>

                                              <th>Listing Name</th>

                                              <td>{{ $detailedProduct->productType->listing_type; }}</td>
                                            ...
                                            <tr>
                                              ...
                                              <td>{{ $detailedProduct->stock_id; }}</td>
                                            ...
                                            <tr>
                                              ...
                                              <td>{{ $detailedProduct->productcondition->name; }}</td>
                                            ...
                                            <!-- <tr>
                                              ...
                                              <td>{{$detailedProduct->paper_cart;}}</td>
                                            ...
                                            <!-- <tr>
                                              ...
                                              <td>{{$detailedProduct->cost_code;}}</td>
                                              ...
                                              @if ($detailedProduct->$countCustom != '')

                                              <tr>

                                                <th>{{$detailedProduct->productType->$countCustom}}</th>

                                                <td>{{$detailedProduct->$countCustom}}</td>
                                              ...
                                              <td>{{money_format("%(#1n", $detailedProduct->msrp)."\n"}}</td>
                            ...
                            <div class="tab-pane fade" id="tab_default_2">
                                ...
                                <div class="p-4">
                                    ...
                                    <div class="embed-responsive embed-responsive-16by9">
                                        ...
                                        @elseif ($detailedProduct->video_provider == 'google_drives')

                                            <iframe class="embed-responsive-item" src="{{ $detailedProduct->video_link}}"></iframe>
                    ...
                    <div class="bg-white rounded shadow-sm">
                        ...
                        <div class="p-3">
                            ...
                            <div class="aiz-carousel gutters-5 half-outside-arrow" data-items="5" data-xl-items="3" data-lg-items="4"  data-md-items="3" data-sm-items="2" data-xs-items="2" data-arrows='true' data-infinite='true'>
                                ...
                                @foreach (filter_products(\App\Product::where('category_id', $detailedProduct->category_id)->where('id', '!=', $detailedProduct->id)->where('model', '!=', $detailedProduct->model)->groupBy('model'))->limit(10)->get() as $key => $related_product)
                                    ...
                                    <div class="aiz-card-box border border-light rounded hov-shadow-md my-2 has-transition">
                                        ...
                                        <div class="p-md-3 p-2 text-left">
                                            ...
                                            <h3 class="fw-600 fs-13 text-truncate-2 lh-1-4 mb-0 h-35px">
                                                ...
                                                <a href="{{ route('product', $related_product->slug) }}" class="d-block text-reset">{{ translate('Model Number :')}}{{ $related_product->model}}</a>
                ...
                <form class="" action="{{ route('conversations.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body gry-bg px-3 pt-3">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control mb-3" name="title" value="" placeholder="{{ translate('Company Name') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control mb-3" name="title" value="" placeholder="{{ translate('Reference') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control mb-3" name="title" value="" placeholder="{{ translate('Contact Name') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control mb-3" name="title" value="" placeholder="{{ translate('Email') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control mb-3" name="title" value="" placeholder="{{ translate('Contact Number') }}" required>
