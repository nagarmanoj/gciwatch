               ...
               <table width="100%" style="width: 100%;" border="0">
                   <tbody><tr>
                       ...
                       <td style="width:  30%;">
                           ...
                           <h4 style="font-weight: bold;text-decoration:underline">INVOICE</h4>
                           <p>Memo No : SALE101{{$memo->id}}</p>
                                <!--Invoice-->

                           @elseif($memo_det->item_status == '3')
                           <h4 style="font-weight: bold;text-decoration:underline">RETURN</h4>
                           <p>Memo No : RETURN101{{$memo->id}}</p>
                              <!--Return-->

                           @elseif($memo_det->item_status == '4')
                           <h4 style="font-weight: bold;text-decoration:underline">TRADE</h4>
                           <p>Memo No : TRD101{{$memo->id}}</p>
                            <!--Trade-->

                           @elseif($memo_det->item_status == '5')
                           <h4 style="font-weight: bold;text-decoration:underline">VOID</h4>
                           <p>Memo No : VOID101{{$memo->id}}</p>
                                <!--Void-->

                           @elseif($memo_det->item_status == '6')
                           <h4 style="font-weight: bold;text-decoration:underline">TRADE NGD</h4>
                           <p>Memo No : TNGD101{{$memo->id}}</p>
                           <!--Trade NGO-->
                           @endif
                           @endif
                           @endforeach
                           <p>DATE :  {{ date('m/d/Y', strtotime($memo->created_at)) }} </p>
                       </td>
                   </tr>
                   <tr>
                       <td colspan="3">
                                   ...
                                   <td style="font-size:10px;text-align: center;font-weight: bold;border-bottom: 1px solid #000000;">TOTAL</td>
                                      ...
                                      @foreach ($memo_details_data as  $memo_det)
                                       <tr>
                                           ...
                                           <td style="font-size:10px;text-align: left;padding: 2px;border-bottom: 1px solid #000000;border-right: 1px solid #000000;" valign="top">
                                             @if($memo_det->item_status == '1' || $memo_det->item_status == '0')
                                                <h3 style="font-size: 10px;">  Memo </h3>
                                             @endif
                                             @if($memo_det->item_status == '2')
                                                <h3 style="font-size: 10px;">  Invoice </h3>
                                             @endif
                                             @if($memo_det->item_status == '3')
                                                 <h3 style="font-size: 10px;"> Return </h3>
                                             @endif
                                             @if($memo_det->item_status == '4')
                                               <h3 style="font-size: 10px;">   Trade </h3>
                                             @endif
                                             @if($memo_det->item_status == '5')
                                              <h3 style="font-size: 10px;">    Void </h3>
                                             @endif
                                             @if($memo_det->item_status == '6')
                                                 <h3 style="font-size: 10px;">  Trade NGD </h3>
                                             @endif
                                           ...
                                           <td style="font-size:10px;text-align: left;padding: 2px;border-bottom: 1px solid #000000;border-right: 1px solid #000000;" valign="top">
                                            ...
                                            <h3 style="font-size: 10px;"> {{ date('m/d/Y', strtotime($memo->date)) }} </h3>
                                           </td>

                                           <td style="font-size:10px;text-align: center;border-bottom: 1px solid #000000;border-right: 1px solid #000000;" valign="top">
                                             <h3 style="font-size: 10px;">  {{$memo_det->product_qty}} </h3>
                                             <?php $total_quantity=$memo_det->product_qty+$total_quantity; ?>
                                           </td>

                                           <td style="font-size:10px;text-align: center;border-bottom: 1px solid #000000;border-right: 1px solid #000000;" valign="top">
                                            <h3 style="font-size: 10px;">  {{money_format('%(#10n', $memo_det->product_price)}} </h3>
                                           </td>
                                           //steved

                                           <td style="font-size:10px;text-align: center;border-bottom: 1px solid #000000;border-right: 1px solid #000000;" valign="top">
                                             <h3 style="font-size: 10px;"> {{money_format('%(#10n', $memo_det->row_total)}} </h3>
                                           </td>
                                       </tr>
                                       @endforeach
                               </tbody>
                               ...
                               <td colspan="7">
                                   <table style="width: 100%;border: 1px solid #000000;border-collapse: collapse;">
                                       <tbody>
                                           ...
                                           <tr>
                                           <td style="font-size: 10px;text-align: left;width: 63.95%;font-size: 10px;border-bottom: 1px solid #000000;border-right: 1px solid #000000;" rowspan="5" valign="top">
                                              {{$memo->notes}}<br><br>
                                           </td>
                                           ...
                                           <td style="font-size: 10px;text-align: right;padding: 2px;border-bottom: 1px solid #000000;border-right: 1px solid #000000;">
                                             ...
                                             {{money_format('%(#10n', $memo->sub_total)}}
                                           </tr>
                                           <tr>
                                           ...
                                           <td style="font-size: 10px;text-align: right;padding: 2px;border-bottom: 1px solid #000000;border-right: 1px solid #000000;">
                                                ...
                                                {{money_format('%(#10n', $memo->sale_tax)}}
                                           </td>
                                           </tr>
                                           <tr>
                                           ...
                                           <tr>
                                           <td style="font-size: 10px;padding: 5px;width: 21%;text-align: left;border-bottom: 1px solid #000000;border-right: 1px solid #000000;">TOTAL QTY</td>
                                           <td style="font-size: 10px;text-align:  right;padding: 2px;border-bottom: 1px solid #000000;border-right: 1px solid #000000;">
                                             {{ $total_quantity}}
                                               </td>
                                           </tr>
                                           <tr>
                                           <td style="font-size: 10px;padding: 5px;width: 21%;text-align: left;border-bottom: 1px solid #000000;border-right: 1px solid #000000;">TOTAL</td>
                                           <td style="font-size: 10px;text-align:  right;padding: 2px;border-bottom: 1px solid #000000;border-right: 1px solid #000000;">
                                             {{money_format('%(#10n', $memo->order_total)}}
                                               </td>
                                           </tr>
                                           <!-- <tr>
                                           <td style="font-size: 10px;text-align: left;padding: 5px;width: 21%;border-bottom: 1px solid #000000;border-right: 1px solid #000000;">TOTAL</td>
                                           <td style="font-size: 10px;text-align: right;padding: 2px;border-bottom: 1px solid #000000;border-right: 1px solid #000000;">
                                                <p style="font-size: 10px;"> {{money_format('%(#10n', $memo->order_total)}} </p>
                                           </td>
                                           </tr> -->
                                   </tbody>
                               </table>
