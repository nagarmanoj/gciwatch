    ...
    <div class="card">
        ...
        <form action="{{route('agent.update', $agent->id)}}" class="form-horizontal bv-form" role="form" id="add-customer-form" method="post" >
            ...
            <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select" name="expertise_id" >
                                    ...
                                    <option value="3" >Jewelry Polish</option>
                                    <option value="4">Watch Polish</option>
                                    <option value="5" >Jewelry and Watch</option>
                                </select>
                            </div>
                            <div class="form-group">
                                <label for="status">Status *</label> 
                                <select name="is_active" id="status" class="form-control select">
                                    <option value="1" @if($agent->is_active=='1') {echo "selected";} @endif>Active</option>
                ...
                <p><input type="submit" name="add_user" value="Add Agent" class="btn btn-primary"></p>
            </div>
        </form>
    </div>
</div>
