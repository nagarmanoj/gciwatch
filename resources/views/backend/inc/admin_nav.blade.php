<div class="aiz-topbar px-15px px-lg-25px d-flex align-items-stretch justify-content-between micustomPrem">
    <div class="d-flex">
        ...
        <div class="aiz-topbar-logo-wrap d-xl-none d-flex align-items-center justify-content-start">
            ...
            <!-- <a href="{{ route('admin.dashboard') }}" class="d-block">
                ...
                @else
                    <img src="{{ static_asset('assets/img/logo2.png') }}" class="brand-icon" alt="{{ get_setting('website_name') }}">
                @endif
            </a> -->
        </div>
    </div>
