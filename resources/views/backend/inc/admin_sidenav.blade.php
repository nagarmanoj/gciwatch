<div class="aiz-sidebar-wrap">
    <div class="aiz-sidebar left c-scrollbar">
            ...
            <!-- Product -->
                ...
                @if(Auth::user()->user_type == 'admin' || in_array('2', json_decode(Auth::user()->staff->role->permissions)))
                    ...
                    <li class="aiz-side-nav-item">
                        ...
                        @if(Auth::user()->user_type == 'admin' || in_array('19', json_decode(Auth::user()->staff->role->inner_permissions)))
                            <li class="aiz-side-nav-item">
                            ...
                            <a href="{{route('productcondition.index')}}" class="aiz-side-nav-link">
        ...
        @endif
           ...
           @if(Auth::user()->user_type == 'admin' || in_array('81', json_decode(Auth::user()->staff->role->permissions)))
         ...
         @endif
         @if(Auth::user()->user_type == 'admin' || in_array('82', json_decode(Auth::user()->staff->role->permissions)))
          ...
          @endif
          @if(Auth::user()->user_type == 'admin' || in_array('83', json_decode(Auth::user()->staff->role->permissions)))
                    ...
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            <li class="aiz-side-nav-item">
                                ...
                                @endif
                            @if(Auth::user()->user_type == 'admin' || in_array('79', json_decode(Auth::user()->staff->role->inner_permissions)))
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('seller_sale_report.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['seller_sale_report.index'])}}">
