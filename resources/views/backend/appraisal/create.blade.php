...
<div class="">
  ...
  <form class="p-4" action="{{route('Appraisal.save')}}" method="POST" id="memo_status">
            ...
            <div class="col-sm-12 col-md-12 col-lg-6">
                ...
                <div class="form-group">
                    ...
                    <select name="template_name" id="template" class="form-control aiz-selectpicker" required>
                        ...
                        <option value="mylux">MyLux</option>

                        <option value="mywatch">MyWatch</option>
                ...
                <div class="form-group" id="unit_price2">
                  ...
                  <select name="stock_id" id="stock_id" class="form-control stock_id_function " data-live-search="true" required>
                  ...
                  <!-- start  -->
                    ...
                    <div class="form-group" id="cls_stock_details" style="">
                        ...
                        <input type="hidden" name="appraisal_location" id="appraisal_location" value="Los Angeles, CA 900014">

                        <p>

                            <b>Manufacturer* :</b>

                            <input type="text" name="manufacturer" id="manufacturer" value="" class="form-control text_input" required>
                        ...
                        <p>
                            ...
                            <input type="text" name="model_name" id="model_name" value="" class="form-control text_input" required>
                        ...
                        <p>
                            ...
                            <input type="text" name="factory_model" id="factory_model" value="" class="form-control text_input" required>
                        ...
                        <p>
                            ...
                            <input type="text" name="serial_no" id="serial_no" value="" class="form-control text_input" required>
                        ...
                        <p>
                            ...
                            <input type="text" name="size" id="size" value="" class="form-control text_input" required>
                        ...
                        <p>
                            ...
                            <input type="text" name="dial" id="dial" value="" class="form-control text_input" required>
                        ...
                        <p>
                            ...
                            <input type="text" name="bazel" id="bezel" value="" class="form-control text_input" required>
                        ...
                        <p>
                            ...
                            <input type="text" name="metal" id="metal" value="" class="form-control text_input" required>
                        ...
                        <p>
                            ...
                            <input type="text" name="bracelet_meterial" id="bracelet_meterial" value="" class="form-control text_input" required>
                        ...
                        <p>
                            ...
                            <input type="text" name="crystal" id="crystal" required="required" class="form-control text_input" data-bv-field="crystal" required>
                        ...
                        <p>
                            ...
                            <input type="text" name="sp_value" id="sp_value" required="required" class="form-control text_input" data-bv-field="sp_value" required>
                        ...
                        <p>
                            ...
                            <input type="text" name="appraised_name" id="appraised_name" required="required" class="form-control text_input" data-bv-field="name" required>
                        ...
                        <p>
                            ...
                            <input type="text" name="appraised_address" id="appraised_address" required="required" class="form-control text_input" data-bv-field="address" required>
                        ...
                        <p>
                            ...
                            <input type="text" name="appraisal_city" id="appraisal_city" required="required" class="form-control text_input" data-bv-field="city" required>
                        ...
                        <p>
                            ...
                            <input type="text" name="appraisal_state" id="appraisal_state" required="required" class="form-control text_input" data-bv-field="state" required>
                        ...
                        <p>
                            ...
                            <input type="text" name="appraisal_zipcode" id="appraisal_zipcode" required="required" class="form-control text_input" data-bv-field="zipcode" required>
                        ...
                        <p>
                            ...
                            <input type="text" name="appraisal_number" id="appraisal_number" required="required" class="form-control text_input" data-bv-field="appraisal_number" required>
                        ...
                        <p>
                            ...
                            <input type='hidden' value="{{date('m/d/20y')}}" name="appraisal_date">
