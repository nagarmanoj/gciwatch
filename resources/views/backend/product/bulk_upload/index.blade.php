...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <h5 class="mb-0 h6"><strong>{{translate('Download Product File')}}</strong></h5>
        </div>
        <div class="card-body">
            <form class="form-horizontal" action="{{route('product-export.download')}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="form-group row">
                    <div class="col-sm-4">
                      <select class="form-control aiz-selectpicker" data-live-search="true"  name="P_type_upload" required>
                    ...
                    <div class="col-sm-9">
                        <div class="custom-file">
    						<label class="custom-file-label">
    							<input type="file" name="bulk_file" accept=".xls,.xlsx,.csv"  class="custom-file-input" required>
