...
<div class="aiz-titlebar text-left mt-2 mb-3">
	...
	<div class="align-items-center">
			...
			<h1 class="h3">{{translate('All Job Orders (Open)')}}</h1>
    ...
    <div class="dropdown mb-2 mb-md-0 trans_mi">
		...
		<div class="card" style="margin-top:20px;">
            ...
            <div class="mi_custome_table">
                <form method="get" id="pagination_form" action="{{route('job_orders.open')}}">
                          ...
                          @foreach($jobOrderData  as $key => $jobData)
                            ...
                            @endphp
                                ...
                                <tr>
                                    ...
                                    <td>  <a style="text-decoration:none;color:#000;" href="{{ route('job_orders.edit',['id'=>$jobData->id, 'lang'=>env('DEFAULT_LANGUAGE')] )}}" title="{{ translate('Edit') }}">@if($jobData->job_status==1)
