...
<div class="aiz-titlebar text-left mt-2 mb-3">
    <h5 class="mb-0 h6">{{translate('Model Number Information')}}</h5>
</div>
...
<div class="col-lg-8 mx-auto">
    <div class="card">
        <div class="card-body p-0">
            ...
            @endif
            <form class="p-4" action="{{ route('model.update', $partners->id) }}" method="POST">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="number" placeholder="{{ translate('Low Stock')}}" id="low_stock" name="low_stock" class="form-control" required value="{{ $partners->low_stock }}">
                    </div>
                </div>
